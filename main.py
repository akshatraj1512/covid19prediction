...
with header:
    st.markdown(
        ...
        .css-1aumxhk {background-color: #004c99; color: white;}
        </style>
        """,
    ...
    st.markdown(
        ...
        <h1 style="color: white;">COVID-19 detection enhancement 
...
with col1:
    ...
    st.image('static/covid19.png', caption='COVID-19', use_container_width=True)

with col2:
    st.markdown("<hr>", unsafe_allow_html=True)
    st.image('static/normal.jpg', caption='Normal', use_container_width=True)
